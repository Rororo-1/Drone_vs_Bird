...
Взагалі, це можна було б зробити, коли я створював датасет, і з часом я скоріш за все так і зроблю. Але в данний момент, я працбвав з кодом, що використовував в DroneDetect і там імпорт і розділення були майже котові, тож я його по мінімуму переробив. 
