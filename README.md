...
В програмі я розділяю дату на 3 частини train - val - test, для того, аби при розділені не було перекосу в сторону якогось з класу, я роблю це окремо для кожного з 2 класів, після чого об'єдную їх в спільний train_im - для зображень, train_lb - для міток. Те саме зроблено і для val, test.

Взагалі, це можна було б зробити, коли я створював датасет, і з часом я скоріш за все так і зроблю. Але на данних момент я підсосовувався під той код, що я писав для датасету drone-detection, тож я його по мінімуму перероблював. 

Я зупинився на моделі yolov8n, адже вона швидка, легка і доволі точна, а я планую в майбутньому інтегруввати її в якийсь проект з робототехніки, тож використовувати бульшу не має сенсу. 
### Структура програми:
